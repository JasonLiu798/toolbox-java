...
public class JSONHelperJ {
    ...
    private static Logger logger = LoggerFactory.getLogger(JSONHelperJ.class);
    ...
    public JSONHelperJ(Inclusion inclusion) {
    ...
    public JSONHelperJ(Inclusion inclusion, boolean isIgnore) {
        mapper = new ObjectMapper();
        // 设置输出包含的属性
        mapper.getSerializationConfig().withSerializationInclusion(inclusion);
        // 设置输入时忽略JSON字符串中存在而Java对象实际没有的属性
     ...
     */
    public static JSONHelperJ buildNormalBinder() {
        return new JSONHelperJ(Inclusion.ALWAYS);
    }
     ...
     * @return JSONHelper
     */
    public static JSONHelperJ buildNormalIgnoreBinder() {
        return new JSONHelperJ(Inclusion.ALWAYS, true);
    }

    /**
     * 创建只输出非空属性到Json字符串的Binder.
     */
    public static JSONHelperJ buildNonNullBinder() {
        return new JSONHelperJ(Inclusion.NON_NULL);
    }

    /**
     * 创建只输出初始值被改变的属性到Json字符串的Binder.
     */
    public static JSONHelperJ buildNonDefaultBinder() {
        return new JSONHelperJ(Inclusion.NON_DEFAULT);
    }
