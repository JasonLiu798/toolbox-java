...
public final class MemcacheHelper {
    ...
    private static class SingletonHolder {
         ...
         * 静态初始化器，由JVM来保证线程安全
         */
        private static MemcacheHelper instance = new MemcacheHelper();
    }

    /**
     * 得到新实例
     */
    public static MemcacheHelper newInstance(MemcachedConfiguration configuration) {
        MemcacheHelper helper = SingletonHolder.instance;
