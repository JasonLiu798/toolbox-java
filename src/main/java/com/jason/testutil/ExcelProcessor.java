...
import com.jason.common.JStringUtil;
import com.jason.excel.Excel;
    ...
    public Object generateParameter(String parameterObjectClass,List<String> parameterNames,
        ...
        try {
            ...
            for(int i =0;i< parameterNames.size();i++){
                ...
                String methodname = "set" + JStringUtil.captureName(parameterName);
...
//            String methodname = "set" + JStringUtil.captureName("uid");
