...
import com.jason.constant.StringConstants;
...
public class NumberUtil {
    ...
    public static String filterDot(String number){
        int dotidx = number.indexOf(StringConstants.DOT);
        String res = number;
        if(dotidx>0){
    ...
    public static void main(String[] args) {
        System.out.println(filterDot("23"));
        System.out.println(filterDot("1.23"));
        System.out.println(filterDot("0.23"));
    }
