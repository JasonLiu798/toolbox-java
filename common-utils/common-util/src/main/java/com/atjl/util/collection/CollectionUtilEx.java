...
/**
 * extend Collection utils
 *
 * @author JasonLiu798
 * @date 2014/11/20 16:20
 */
@Slf4j
public final class CollectionUtilEx {
    ...
    public static <T> List<T> getDuplicateItemUseHash(List<T> mainList, List<T> otherList) {
        if (CollectionUtilEx.isEmpty(mainList) || CollectionUtilEx.isEmpty(otherList)) {
    ...
    public static <T> T[] set2array(Set<T> set) {
        if (CollectionUtilEx.isEmpty(set)) {
    ...
    public static <T> List<T> array2List(T[] array) {
        if (CollectionUtilEx.isEmpty(array)) {
            return null;
        }
    ...
    public static <T> List<T> deleteDuplicatItemLoop(List<T> mainList, List<T> deleteList, Method checkMethod) {
        if (CollectionUtilEx.isEmpty(mainList) || CollectionUtilEx.isEmpty(deleteList)) {
            return mainList;
        }
...
//        Lists.newArrayListWithCapacity(100);
    ...
    public static Map<String, String> newStringMap(String... values) {
        if (CollectionUtilEx.isEmpty(values)) {
            return new HashMap<>();
        }
