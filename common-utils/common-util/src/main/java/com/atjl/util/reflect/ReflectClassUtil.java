...
public class ReflectClassUtil {
    ...
    private static Logger logger = LoggerFactory.getLogger(ReflectClassUtil.class);
     ...
     * @return instance
     */
    public static Object newInstance(String classStr) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
    ...
    public static Object newInstance(Class clz, Class[] paramClz, Object[] params) {
        try {
