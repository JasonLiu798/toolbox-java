...
import com.atjl.validate.validator.param.form.FormReqWithAll;
import org.junit.*;
import org.junit.rules.ExpectedException;


public class RequiredWithAllTest {


    
    @Test
    public void testValidate() throws Exception {
        ValidateForm f = ValidateFormFactory.build(FormReqWithAll.class);
