...
import com.atjl.dbtiming.api.exception.TimingException;
...
public class TimingServiceImpl implements TimingService {
    ...
    public void init() {
        ...
        state = State.STARTING;//state to starting
        ...
        state = State.RUNNING;//state to running
    }
     ...
     */
    @Override
    public RetCode manualRun(Long tid, String paramStr) {
